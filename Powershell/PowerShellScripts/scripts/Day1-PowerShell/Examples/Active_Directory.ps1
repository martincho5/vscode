...
# Delete a user
remove-aduser "cn=Billy Corgan,ou=boston,ou=east_coast,dc=testing,dc=local"
...
set-adaccountpassword Justin -reset -newpassword $(read-host -assecurestring)
...
set-adcomputer SERVER44 -OperatingSystem "Server 2012"
