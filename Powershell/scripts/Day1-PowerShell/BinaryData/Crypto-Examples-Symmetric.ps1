...
# Public key crypto examples are in a different script.
...
# DPAPI by a user X on computer Y can only be decrypted by X on Y.
#
##############################################################################
...
# Encrypt the plaintext bytes using a hidden managed by the DPAPI, with or without
