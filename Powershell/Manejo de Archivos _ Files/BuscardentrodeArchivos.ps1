...
Get-ChildItem -recurse | Select-String -pattern "powershell" | Export-CSV d:\powerhsell.csv
Get-ChildItem -recurse | Select-String -pattern "192.168.64" | Export-CSV d:\IP.csv
