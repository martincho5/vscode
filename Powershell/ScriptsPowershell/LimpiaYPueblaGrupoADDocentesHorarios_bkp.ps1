...
try{
    Get-ADGroupMember -Identity 'DocentesHorarios' -Server 'xxxx.xxx.xx    ' | ForEach-Object {Remove-ADGroupMember "DocentesHorarios" $_ -Confirm:$false}
}
catch{
...
$connectionString = 'User ID=user;Password=password;Data Source=(DESCRIPTION =
